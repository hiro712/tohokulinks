			...
			<li class="fadeUpTrigger">
                ...
                <li class="fadeUpTrigger">
					<section>
						...
						<div class="box">
							<p>以前のUIは<a href="old/login.html" target="_blank"><u>ここから→</u></a>利用できます。どうぞご利用ください。</p>
						</div>
					</section>
				</li>
			</ul>
...
<div id="g-nav-list">
    ...
    <small>&copy; 2021 Hiroto ABE, Tohoku University Inc. All Rights Reserved. Ver.2.0.0</small>
