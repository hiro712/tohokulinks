...
<section id="topics">
    <h2>News<small>クリックすると詳細を表示します。</small></h2>
    <ul class="slider">
    ...
    <div id="info0" class="hide-area">
        ...
        <u><p>2021/11/07<br></p></u>
          <p class="imp">11/15(月)0:00より新UIに変更になります。それに伴いURLが変更になるため、ブックマークなどしている場合はご注意ください。新しいURLは<a href="https://tohokulinks.herokuapp.com/index.html" target="_blank">https://tohokulinks.herokuapp.com/index.html</a>になります。現在はまだ使用できません。<span class= "newicon">NEW</span></p>
        <u><p>2021/10/04<br></p></u>
          <p>「Google Classroom」と「LINKS」のセクションを入れ替えました。「Google Classroom」を使う頻度の方が多いため、ページ上部にあったほうが良いというご提案をいただきました。</p>
        <u><p>2021/10/01<br></p></u>
          <p>「TOHOKULINKS」を使っていただきありがとうございます。さて、今日から後期が始まりました。良かったらこのサイトをTwitterなどで広めていただけると嬉しいです。これからも開発・運営へのご協力よろしくおねがいします。</p>
        <u><p>2021/10/01<br></p></u>
          <p>「使い方」を更新しました。09/27にお知らせに書いた、間違った時間割を登録してしまった場合の項目を追加しました。</p>
        <u><p>2021/10/01<br></p></u>
          <p>全ての Google Classroom へのリンクを新しいタブで開くようにしました。</p>
        <u><p>2021/09/27<br></p></u>
          <p>間違って時間割を登録してしまった場合の対処法をご紹介します！まず、もう一度時間割を登録すると上書きできます。入力ミスなどはもう一度登録してください。
              ...
              分からないことがありましたら「お問い合わせ」よりご連絡ください。</p>
        <u><p>2021/09/23<br></p></u>
          <p>Ver.1.4に伴って、「使い方」を更新しました。ご覧ください。</p>
        <u><p>2021/09/23<br></p></u>
          <p class="update">Ver.1.4アップデート情報！ ご要望により、「LINKS」に登録できるURLを3つ追加しました。</p>
        <u><p>2021/09/20<br></p></u>
          <p class= "update">Ver.1.2.0アップデート情報！ ご要望により、ユーザー名変更とアカウント削除の項目を追加しました。「アカウント管理」よりパスワード・ユーザー名変更、アカウント削除、プライバシーポリシーの閲覧が行えます。その他、細かい変更を行いました。</p> 
        <u><p>2021/09/20<br></p></u>
          <p>本日午前2時-4時の間、アップデートのため一時的にサーバーを停止しました。</p> 
        <u><p>2021/09/18<br></p></u>
          <p class= "update">Ver.1.1.0アップデート情報！ ログイン画面にもお知らせを表示しました。</p> 
        <u><p>2021/09/18<br></p></u>
          <p>時間割を削除したいときは、科目名に - 、URLに delete と入力してください。</p> 
        <u><p>2021/09/18<br></p></u>
          <p class= "imp">必ず使い方をよく読んでからご利用ください。</p> 
        <u><p>2021/09/18<br></p></u>
          <p>ユーザー名、パスワードは40文字以内で登録してください。40文字以上で登録しても40文字目までしか反映されません。</p> 
        <u><p>2021/09/18<br></p></u>
          <p>本日TOHOKULINKSをTwitterにて公開しました！</p> 
        <u><p>2021/09/02<br></p></u>
          <p>本日TOHOKULINKSを公開しました。登録してご利用ください。</p>
